...
public class MonitoringMail
{
	...
	public boolean send_E_Mail(String mailServer, String from, String[] to, String subject, String messageBody, String attachmentPath, String attachmentName) throws AddressException, MessagingException
	{
		try {
			sendMail( mailServer,  from,  to, subject,  messageBody, attachmentPath, attachmentName);
			return true;
		}
		catch (Exception e) {
			return false;
